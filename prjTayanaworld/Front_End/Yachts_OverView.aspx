<%@ Page Title="" Language="C#" MasterPageFile="~/Front_End/FrontMaster.Master" AutoEventWireup="true" CodeBehind="Yachts_OverView.aspx.cs" Inherits="prjTayanaworld.Front_End.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <ItemTemplate>
                                <li>
                                    <a href='<%#"/Back_End/YachtsImg/"+Eval("FileName") %>'>
                                        <img src='<%#"/Back_End/YachtsImg/"+"mini"+Eval("FileName") %>'>
                                    </a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;</li>
                            </ItemTemplate>
                        </asp:Repeater>
    ...
    <div class="conbg">
            ...
            <div class="left1">
                ...
                <ul>
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li><a href='<%#"Yachts_OverView.aspx?id="+Eval("id") %>'>
        ...
        <!--------------------------------右邊選單開始---------------------------------------------------->
        <div id="crumb">
            <a href="index.aspx">Home</a> >> <a href="Yachts_OverView.aspx">Yachts</a> >> <a href="#"><span class="on1">
                ...
                <div class="downloads">
                    ...
                    <ul>
                        <asp:Repeater ID="Repeater3" runat="server">
                            <ItemTemplate>
                                <li>
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"/Back_End/OverviewPDF/"+Eval("OverViewDownload") %>' Target="_blank">Downloads<asp:Literal ID="litFileName" runat="server" Text='<%#Eval("OverViewDownload") %>'></asp:Literal></asp:HyperLink>
                                </li>
                            </ItemTemplate>
                        </asp:Repeater>
                    </ul>
