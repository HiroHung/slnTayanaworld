<%@ Page Title="" Language="C#" MasterPageFile="~/Front_End/FrontMaster.Master" AutoEventWireup="true" CodeBehind="Yachts_Layout.aspx.cs" Inherits="prjTayanaworld.Front_End.WebForm2" %>
            ...
            <div class="left1">
                ...
                <ul>
                    <asp:Repeater ID="Repeater1" runat="server">
                        <ItemTemplate>
                            <li><a href='<%#"Yachts_Layout.aspx?id="+Eval("id") %>'>
