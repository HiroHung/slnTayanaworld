<%@ Page Title="" Language="C#" MasterPageFile="~/Back_End/MainSite.Master" AutoEventWireup="true" CodeBehind="DealersEdit.aspx.cs" Inherits="prjTayanaworld.Back_End.WebForm13" %>
                ...
                <div>
                    <ul style="padding-inline-start: 20px;">
                        ...
                        <li style="list-style: none; display: flex; justify-content: flex-end">
                            <asp:Button ID="btnUpdate" runat="server" class="btn btn-primary" Text="更新資料" OnClick="btnUpdate_Click" />
