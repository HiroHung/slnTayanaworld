<%@ Page Title="" Language="C#" MasterPageFile="~/Back_End/MainSite.Master" AutoEventWireup="true" CodeBehind="MemberEditDetail.aspx.cs" Inherits="prjTayanaworld.Back_End.WebForm6" %>
                        ...
                        <div>
                            <div style="margin: 20px 20px" class="form-group">
                                <ul style="padding-inline-start: 20px;">
                                    ...
                                    <%--<li>修改密碼：<input runat="server" id="txbPassword" class="form-control" required type="password"></li>
                                    <li>修改密碼確認：<asp:Label ID="lblError" runat="server" Text="請填入確認密碼！" ForeColor="Red" Visible="False"></asp:Label><input runat="server" id="txbCkPassword" class="form-control" required type="password"></li>
                                    ...
                                    <li style="list-style: none; display: flex; justify-content: flex-end">
                                        <asp:Button ID="btnUserInfo" runat="server" Text="修改資料送出" OnClick="btnUserInfo_Click"  class="btn btn-primary"/>&nbsp&nbsp<asp:Button ID="btnCancel" runat="server" OnClick="btnCancel_Click" Text="取消" class="btn btn-success" UseSubmitBehavior="False" />
                                    </li>
                                </ul>
                            </div>
                        </div>
