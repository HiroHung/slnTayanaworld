<%@ Page Title="" Language="C#" MasterPageFile="~/Back_End/MainSite.Master" AutoEventWireup="true" CodeBehind="NewsEdit.aspx.cs" Inherits="prjTayanaworld.Back_End.WebForm10" %>
            ...
            <div class="panel-body">
                ...
                <div style="display: flex" class="form-group">
                    <div>
                        ...
                        <br>
                        <p>
                            <asp:Button ID="btnUpdateNews" runat="server" Text="新聞更新" class="btn btn-primary" OnClick="btnUpdateNews_Click" />
                            <asp:Button ID="btnCancel" runat="server" Text="取消" class="btn btn-success" OnClick="btnCancel_Click" />
                        </p>
                    </div>
